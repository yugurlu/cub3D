	...
	while (cub3d->map.map[++y])
	{
		...
		while (cub3d->map.map[y][++x])
		{
			if (cub3d->map.map[y][x] == '1')
			{
				...
				cub3d->mlx.mlx_minimap_data[pixel_y * 160 + pixel_x
					+ 3] = 0x00FF00;
				cub3d->mlx.mlx_minimap_data[(pixel_y + 1) * 160
					+ pixel_x] = 0x00FF00;
				cub3d->mlx.mlx_minimap_data[(pixel_y + 1) * 160 + pixel_x
					+ 1] = 0x00FF00;
				cub3d->mlx.mlx_minimap_data[(pixel_y + 1) * 160 + pixel_x
					+ 2] = 0x00FF00;
				cub3d->mlx.mlx_minimap_data[(pixel_y + 1) * 160 + pixel_x
				...
				cub3d->mlx.mlx_minimap_data[(pixel_y - 1) * 160 + pixel_x
					+ 3] = 0x00FF00;
				cub3d->mlx.mlx_minimap_data[(pixel_y - 2) * 160
					+ pixel_x] = 0x00FF00;
				cub3d->mlx.mlx_minimap_data[(pixel_y - 2) * 160 + pixel_x
					+ 1] = 0x00FF00;
				cub3d->mlx.mlx_minimap_data[(pixel_y - 2) * 160 + pixel_x
					+ 2] = 0x00FF00;
				cub3d->mlx.mlx_minimap_data[(pixel_y - 2) * 160 + pixel_x
					+ 3] = 0x00FF00;
				cub3d->mlx.mlx_minimap_data[(pixel_y - 3) * 160
					+ pixel_x] = 0x00FF00;
